...
export const InputStage: React.FC<InputStageProps> = ({ onAnalyze, isLoading }) => {
    ...
    <div className="flex flex-col items-center justify-center min-h-screen w-full p-4 md:p-8 animate-slide-up">
      ...
      <div className="w-full max-w-3xl bg-concrete border-2 border-ink shadow-[8px_8px_0px_0px_rgba(26,26,26,1)] relative overflow-hidden">
        ...
        <div className="p-6 md:p-10 flex flex-col gap-6">
          ...
          {/* Control Panel */}
          <div className="flex flex-col md:flex-row justify-between items-center gap-4 border-t-2 border-ink/10 pt-6">
            <button 
              onClick={loadSample}
              disabled={isLoading}
      ...
      {/* Footer Meta */}
      <div className="mt-8 font-mono text-xs text-ink/40 text-center">
        POWERED BY GEMINI 3 FLASH • DESIGNED BY [USER]
      </div>
    </div>
  );
};